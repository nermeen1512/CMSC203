...
public class PasswordCheckerTest {
	...
	ArrayList<String> passwordStudent;
	...
	public void setUp() throws Exception {
		...
		passwordStudent = new ArrayList<String>();
		String[] pStudent = {"255455XX", "ImL%6fireet", "nermeen2LLL", "mal5%", "bertha22#", "ward8Mango$", 
				...
				"myPassword2"};
		passwordStudent.addAll(Arrays.asList(pStudent));
	 ...
	 */
	@Test
	public void testGetInvalidPasswords() throws LengthException, NoDigitException, NoUpperAlphaException, NoLowerAlphaException, InvalidSequenceException, NoSpecialCharacterException {
